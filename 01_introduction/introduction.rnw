...
<<area_map, fig.cap="Study area highlighting road geometries outlined in a lighter 30m buffer", fig.pos = "t">>=
...
\begin{itemize}
    ...
    \item Using OS Road and LiDAR Data produce an automated method for determining the characteristics of roads that relate to overall road quality. These are;
