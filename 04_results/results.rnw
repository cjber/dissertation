...
ggRGB(aerial) +
  ...
  geom_sf(data = road_lm[road_lm$road_id == "road_6", ], colour = "green") +
...
ggRGB(aerial) +
  geom_sf(data = rd, colour = "red") +
  geom_sf(data = road_lm90[road_lm$road_id == "road_6", ], colour = "green") +
  geom_sf(data = centrelines, colour = "red", alpha = 1) +
  theme_map() +
  theme(panel.border = element_rect(
    colour = "black",
...
ggRGB(aerial) +
  geom_sf(data = rd, colour = "red") +
  geom_sf(data = road_lm80[road_lm$road_id == "road_6", ], colour = "green") +
  geom_sf(data = centrelines, colour = "red", alpha = 1) +
  theme_map() +
  theme(panel.border = element_rect(
    colour = "black",
...
<<>>=
# use final_cent1
widths_1 <- widths_1[widths_1$road_id == "road_6", ]
widths_2 <- widths_2[widths_2$road_id == "road_6", ]
widths_3 <- widths_3[widths_3$road_id == "road_6", ]
widths_IND <- widths_IND[widths_IND$road_id == "road_6",]
