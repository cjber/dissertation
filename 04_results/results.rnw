...
mean((filter$lmI_dum == 1) == (filter_las$road == 1))
@
...
ggRGB(aerial) +
  geom_rect(data = bg, aes(xmin = xmin, xmax = xmax, ymin = ymin, ymax = ymax), fill = NA, colour = "black", size = 2) +
