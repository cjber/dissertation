...
<<hist_lidar, fig.cap="LiDAR point cloud intensity distribution, post noise filtering", fig.showtext=TRUE, fig.height = 4>>=
...
<<lmdistributions, fig.cap = "Linear Model Probability Distributions for the Maximal Model, showing vertical lines at the 95th, 90th, and 80th quantile of the distribution", fig.height = 4>>=
